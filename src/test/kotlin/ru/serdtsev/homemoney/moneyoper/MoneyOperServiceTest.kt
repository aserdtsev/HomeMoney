...
internal class MoneyOperServiceTest {
    ...
    private val service = MoneyOperService(balanceSheetDao, moneyOperDao, mock {  }, balanceDao, tagDao)
    ...
    fun getTagsSuggest() {
        ...
        whenever(moneyOperDao.findByBalanceSheetAndStatusAndPerformedGreaterThan(any(), any(), any()))
            .thenReturn(opers)

        whenever(tagDao.findByBalanceSheetOrderByName(balanceSheet))
            .thenReturn(tagsA)
